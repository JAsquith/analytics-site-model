package analytics.pages.reports.components;
...
public class ReportsHome_YearAccordion extends AnalyticsComponent {
    ...
    // CONSTRUCTOR
    public ReportsHome_YearAccordion(AnalyticsDriver aDriver, String yearNumber){
        super(aDriver);
        this.init(yearNumber, "");
    }

    public ReportsHome_YearAccordion(AnalyticsDriver aDriver, String yearNumber, String forTracker){
        super(aDriver);
