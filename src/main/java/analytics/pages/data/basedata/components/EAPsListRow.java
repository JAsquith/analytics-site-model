package analytics.pages.data.basedata.components;

import analytics.AnalyticsDriver;
import analytics.pages.AnalyticsComponent;
import analytics.pages.data.basedata.EAPDetail;
...
public class EAPsListRow extends AnalyticsComponent{
     ...
     */
    public EAPsListRow(AnalyticsDriver aDriver, String eapName) {
        super(aDriver);
