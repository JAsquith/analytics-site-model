...
//    }
    ...
    public void takeScreenshot(AnalyticsDriver driver, String testId, String fileName) {
        takeScreenshot(driver, 1, "Main", testId, fileName);
    }

    public void takeScreenshot(AnalyticsDriver driver, int index, String window, String testId, String fileName) {
        takeScreenshot(driver, index, window, Level.INFO, testId, fileName);
    }

    public void takeScreenshot(AnalyticsDriver driver, int index, String window,
