...
public class GradeFilesListRow extends AnalyticsComponent{
     ...
     */
    public GradeFilesListRow(RemoteWebDriver aDriver, String fileTitle) throws IllegalArgumentException {
        super(aDriver);
     ...
     */
    public GradeFilesListRow(RemoteWebDriver aDriver, int fileIndex) throws IllegalArgumentException {
        super(aDriver);
