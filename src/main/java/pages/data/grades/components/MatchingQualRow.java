...
public class MatchingQualRow extends AnalyticsComponent{
     ...
     */
    public MatchingQualRow(RemoteWebDriver aDriver, String qualName) throws IllegalArgumentException {
        super(aDriver);
        initByName(qualName);
    }
     ...
     */
    public MatchingQualRow(RemoteWebDriver aDriver, int qualIndex) throws IllegalArgumentException {
        super(aDriver);
