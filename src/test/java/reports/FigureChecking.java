...
import analytics.pages.reports.Report;
import analytics.pages.reports.ReportsHome_EAP;
import analytics.pages.reports.components.Report_AddFilters;
...
import analytics.utils.TableDataFileManager;
...
public class FigureChecking extends SISRATest {
    ...
    private Report openReport(){
        ...
        try {
            ...
            ReportsHome_YearAccordion accordion = reportsHome.getYearAccordion(
            ...
            System.out.println("Exception navigating to KS 3/4 reports and opening dataset");
            throw e;
        }
    }
    ...
    private Report applyStudentFilters (Report reportPage){
        ...
        Report_AddFilters filtersModal = reportPage.openFiltersModal();
