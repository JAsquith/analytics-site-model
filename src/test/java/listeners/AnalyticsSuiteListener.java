...
public class AnalyticsSuiteListener implements ISuiteListener, FilenameFilter {
    ...
    public void onFinish(ISuite suite){
        ...
        try {
            ...
            System.out.println("Emailing of test results failed - could not compose email with settings from test.properties");
    ...
    protected MimeMessage composeEmail(String subject) throws SendFailedException {
        ...
        File gridConfig = new File("test.properties");
        try {
            ...
            throw new SendFailedException("The 'test.properties' file was not found or did not contain the required properties");
        }
